...
public final class UserQueryHelper {
    ...
    public static final String SQL_USER_CREATE_TABLE = "CREATE TABLE " + DBReaderContract.DBEntry.TABLE_NAME + " (" + DBReaderContract.DBEntry._ID + " INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL," + DBReaderContract.DBEntry.COLUMN_USERNAME + " TEXT," + DBReaderContract.DBEntry.COLUMN_USER_PASSWORD + " TEXT);";
